...
const FuncionarioForm = () => {
  ...
  // Funções para modais de localização removidas - agora usando componentes especializados
  // Funções para manipulação de cidade removidas
  // Funções para manipulação de estado e país removidas
  // Funções para estado removidas
  // Funções para país removidas
  ...
  const handleSalarioChange = (e, setFieldValue) => {
    ...
    const valorNumerico = parseInt(apenasDigitos || '0', 10) / 100;
    ...
    <Container fluid className="p-0">
      <Card className="border-0 shadow-sm">
        <CardBody>
          ...
          </div>          {error && <Alert color="danger">{error}</Alert>}
            ...
            {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting, setFieldValue }) => (
              <Form onSubmit={handleSubmit}>
                ...
                <Row>
                  ...
                  <Col md={6}>                    <FormGroup>
                      <Label for="cidadeId">Cidade*</Label>                      <div className="d-flex">                        <Input
                          type="text"
                          name="cidadeNome"
                          id="cidadeNome"
                          ...
                          className="flex-grow-1"                          readOnly
                        />
                        <Button
                          outline
                          color="primary" 
                        ...
                        />
                        {touched.cidadeId && errors.cidadeId && <FormFeedback>{errors.cidadeId}</FormFeedback>}
                      </div>
                    </FormGroup>
                  </Col>
                </Row>
